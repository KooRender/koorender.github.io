...
const translations = {
    'en': {
        ...
        'feature_lux3d_title': 'Lux3D Image-to-Model',
        'feature_lux3d_desc': 'Integated Lux3d for generating 3D models with PBR materials from a single image.',
        ...
        'cta_trial_btn': 'Download KooRender for 3ds Max Free Trial',
        ...
        'download_package_btn': 'Download KooRender for 3ds Max',
    ...
    'zh': {
        ...
        'feature_lux3d_title': 'Lux3D图生模型',
        'feature_lux3d_desc': '集成Lux3D用于从单张图片生成带PBR材质的3D模型。',
        'cta_section_title': '准备好改变您的渲染工作流了吗？',
        'cta_section_desc': '加入成千上万使用 KooRender 轻松创作精美视觉效果的创作者。',
        'cta_trial_btn': '下载KooRender for 3ds Max免费试用版',
        'footer_product': '产品',
        'footer_pricing': '定价',
        ...
        'download_package_btn': '下载 KooRender for 3ds Max',
        'step_2_title': '创建账号',
