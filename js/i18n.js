...
const translations = {
    'en': {
        ...
        'step_1_desc': 'Download the latest KooRender software package and complete the installation following the wizard. Make sure your system meets the minimum requirements (Windows 10+, 3ds Max 2021+).',
        ...
        'step_3_step_1': 'Launch your 3ds Max software (2021 or newer version)',
    ...
    'zh': {
        ...
        'step_1_desc': '下载最新的 KooRender 软件包并根据向导完成安装。请确保您的系统满足最低要求（Windows 10+，3ds Max 2021+）。',
        ...
        'step_3_step_1': '启动您的 3ds Max 软件（2021 或更高版本）',
