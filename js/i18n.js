...
const translations = {
    'en': {
        ...
        'step_1_desc': 'Download the latest KooRender software package and complete the installation following the wizard. Make sure your system meets the minimum requirements (Windows 10+, 3ds Max 2023 only, V-Ray 4 or 5).',
    ...
    'zh': {
        ...
        'step_1_desc': '下载最新的 KooRender 软件包并根据向导完成安装。请确保您的系统满足最低要求（Windows 10+，仅支持3ds Max 2023，V-Ray 4 或 5）。',
