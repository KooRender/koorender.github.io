...
const translations = {
    'en': {
        ...
        'agree_terms': 'Terms', 
        'agree_and': 'and', 
        'hero_title': 'KooRender for 3ds Max <span class="badge-3dsmax">3ds Max Plugin</span><br><span class="text-primary">Cloud-based Real-time Renderer</span>',
    ...
    'zh': {
        ...
        'agree_terms': '条款',
        'agree_and': '与', 
        'hero_title': 'KooRender for 3ds Max <span class="badge-3dsmax">3ds Max插件</span><br><span class="text-primary">基于云端的实时渲染器</span>',
